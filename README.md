...
**[Ruby_Enumerable]** is a repo to create ruby-enumerables using module and class.
...
Clone this [repository](https://github.com/yodit93/Ruby_Enumerable.git) to your desired folder.
...
Feel free to check the [issues page](https://github.com/yodit93/Ruby_Enumerable/issues)
